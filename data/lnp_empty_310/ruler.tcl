...
proc ::Ruler::redraw {} {
  ...
  if $::Ruler::ruler_dirty {
    ...
    set logunit [expr ceil(-log10(0.01))-1]
...
proc ::Ruler::draw_scale {} {
  ...
  #graphics $ruler_mol text "[expr -.2*$display_width] [expr -0.6*$display_height] $display_front" "[format "%g" [expr 0.1*$ruler_unit]]nm" size 1.0
  graphics $ruler_mol line "[expr .58*$display_width] [expr -0.8*$display_height] $display_front" "[expr 0.58*$display_width] [expr -0.8*$display_height+$ruler_unit] $display_front" width 15
}
