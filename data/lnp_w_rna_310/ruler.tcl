...
proc ::Ruler::draw_scale {} {
  ...
  graphics $ruler_mol line "[expr .6*$display_width] [expr -0.8*$display_height] $display_front" "[expr 0.6*$display_width] [expr -0.8*$display_height+$ruler_unit] $display_front" width 15
}
